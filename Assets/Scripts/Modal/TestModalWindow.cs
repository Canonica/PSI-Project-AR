...
public class TestModalWindow : MonoBehaviour
{
    ...
    {
        displayManager.DisplayMessage("Heck yeah! Yup!", Color.red);
    }

    void TestNoFunction()
    {
        displayManager.DisplayMessage("No way, José!", Color.red);
    }

    void TestCancelFunction()
    {
        displayManager.DisplayMessage("I give up!", Color.red);
    }
}